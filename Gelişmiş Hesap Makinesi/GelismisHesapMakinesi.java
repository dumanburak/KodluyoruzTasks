...
public class GelismisHesapMakinesi {
    ...
    static void mod() {
        ...
        System.out.print("Sayý giriniz : ");
        sayi = scan.nextInt();
        System.out.print("Girdiðiniz sayýnýn kaç ile bölümünden kalaný öðrenmek istiyorsunuz? : ");
        mod = scan.nextInt();
    ...
    static void alanVeCevre() {
        ...
        Scanner scan = new Scanner(System.in);
        System.out.print("Dikdörtgenin kýsa kenarýný (cm cinsinden) giriniz : ");
        kisa = scan.nextInt();
        System.out.print("Dikdörtgenin uzun kenarýný (cm cinsinden) giriniz : ");
        uzun = scan.nextInt();
        
        alan = kisa * uzun;
        cevre = 2 * (uzun+kisa);
        
        System.out.println("Dikdörtgenin Alaný : "+ alan + " cm^2");
        System.out.println("Dikdörtgenin Çevresi : "+ cevre + " cm");
